...
namespace WebApi.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register([FromBody] RegisterModel registerModel)
        {
            ...
            //user.Role = adminEmails.Contains(user.Email.ToLower()) ? "Admin" : "User";
            ...
            //     var previousUser = await _userService.GetUserByEmailAsync(user.Email);
            ...
            //     var insertUser = _userService.GetUserByEmailAndPassword(user.Email, user.Password);
            //     if (insertUser == null)
            //     {
